...
cmd="bash -c \"export SSHPASS=$(base64 -d <<<"+lalannd2_passwd+");sshpass -d 123 ssh -o StrictHostKeyChecking=no -o ProxyCommand='sshpass -e ssh -W %h:%p lalannd2@tlpalcorr01' lalannd2@"+args+" 123<<<$SSHPASS\"";
